...
function RegisterStepThrStart(props) {
    useEffect(()=>{
        ...
        <StepInfoWrap>
            <StepInfo>
                <StepText>
                    ...
                    <StepDesc>
                        마지막 단계에서는 1박 요금을 설정하실 수 있습니다. 몇 가지 간단한 질문에 답하고 난 후 준비가 되면 숙소 등록을 완료하세요.
                    </StepDesc>
                </StepText>
                ...
                <StepVideoWrap>
                    <StepViedo>
                        <StViedio crossOrigin="anonymous" autoPlay muted>
                            <source type="video/mp4" src="https://stream.media.muscache.com/KeNKUpa01dRaT5g00SSBV95FqXYkqf01DJdzn01F1aT00vCI.mp4?v_q=high"/>
                        </StViedio>
                    </StepViedo>
                </StepVideoWrap>
            </StepInfo>
...
export default RegisterStepThrStart;