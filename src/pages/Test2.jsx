    ...
    return (
        <>
            <RegiHader>
                <div>
                    <span>
                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" style={{display:'block', height:'32px', width:'32px', fill:'black'}} aria-hidden="true" role="presentation" focusable="false">
...
export const RegiHader = styled.div`
    display: flex;
    gap: 0px;
